...
Перевіряє наявність відкритого вікна безпечного обміну.
...
Integer: 1 = TRUE — обмін відкритий; 0 = FALSE — ні.
...
Код проєкту: `src/ClassicUO.Client/Game/Managers/ClassicUOInjectionApiBridge.cs`; функція `IsTrade`.
