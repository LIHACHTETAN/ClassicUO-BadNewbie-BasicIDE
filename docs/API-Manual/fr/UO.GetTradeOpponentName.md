...
Lit le nom reçu à l’ouverture de l’échange.
...
String : nom reçu avec l’échange ; chaîne vide sans fenêtre/nom. Aucune demande de mise à jour.
...
Source du projet: `src/ClassicUO.Client/Game/Managers/ClassicUOInjectionApiBridge.cs`; fonction `GetTradeOpponentName`.
...
# Lit le nom reçu à l’ouverture de l’échange.
#
# String : nom reçu avec l’échange ; chaîne vide sans fenêtre/nom. Aucune demande de mise à
# jour.
