...
Annule l’échange sélectionné et ferme sa fenêtre.
...
Integer : 1 = TRUE si la fenêtre a été trouvée, fermée et son annulation envoyée ; 0 = FALSE si absente. N’attend pas de réponse serveur. Une nouvelle fermeture n’envoie pas un second paquet.
...
Source du projet: `src/ClassicUO.Client/Game/Managers/ClassicUOInjectionApiBridge.cs`; fonction `CancelTrade`.
...
Dispose quitte immédiatement si déjà fermé, libère l’UI puis appelle GameActions.CancelTrade(ID1) une seule fois.

Integer : 1 = TRUE si la fenêtre a été trouvée, fermée et son annulation envoyée ; 0 = FALSE si absente. N’attend pas de réponse serveur. Une nouvelle fermeture n’envoie pas un second paquet.

Source du projet: `src/ClassicUO.Client/Game/UI/Gumps/TradingGump.cs`; fonction `Dispose`.
...
# Annule l’échange sélectionné et ferme sa fenêtre.
#
# Integer : 1 = TRUE si la fenêtre a été trouvée, fermée et son annulation envoyée ; 0 = FALSE
# si absente. N’attend pas de réponse serveur. Une nouvelle fermeture n’envoie pas un second
# paquet.
#
