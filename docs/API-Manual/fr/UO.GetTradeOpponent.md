...
Renvoie le serial numérique du personnage partenaire.
...
Integer : serial du personnage, lu dans LocalSerial ; 0 si fenêtre absente. Ni conteneur ni booléen ; tester <> 0.
...
Source du projet: `src/ClassicUO.Client/Game/Managers/ClassicUOInjectionApiBridge.cs`; fonction `GetTradeOpponent`.
...
# Renvoie le serial numérique du personnage partenaire.
#
# Integer : serial du personnage, lu dans LocalSerial ; 0 si fenêtre absente. Ni conteneur ni
# booléen ; tester <> 0.
