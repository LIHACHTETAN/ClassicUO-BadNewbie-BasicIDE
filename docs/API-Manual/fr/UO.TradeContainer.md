...
Renvoie le serial de votre conteneur en texte hexadécimal.
...
String : ID hexadécimal comme "0x40000011", ou "0x00000000" si absent. Votre conteneur, pas un booléen ni une chaîne vide.
...
Source du projet: `external/InjectionScript/src/InjectionScript/Runtime/InjectionApiUO.cs`; fonction `TradeContainer`.
...
Source du projet: `src/ClassicUO.Client/Game/Managers/ClassicUOInjectionApiBridge.cs`; fonction `TradeContainer`.
...
# Renvoie le serial de votre conteneur en texte hexadécimal.
#
# String : ID hexadécimal comme "0x40000011", ou "0x00000000" si absent. Votre conteneur, pas un
# booléen ni une chaîne vide.
