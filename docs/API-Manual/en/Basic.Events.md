...
- These are script-declared events, raised explicitly by your code. This syntax does not automatically subscribe to game packets or journal changes. Handles, WithEvents, Custom Event, event delegate types and class events are not part of this implementation. Basic event keywords have no UO. prefix; game API calls retain UO.
