...
Restituisce il serial del proprio contenitore come stringa esadecimale.
...
String: ID esadecimale come "0x40000011", oppure "0x00000000" se assente. Proprio contenitore, non Boolean né stringa vuota.
...
Sorgente del progetto: `external/InjectionScript/src/InjectionScript/Runtime/InjectionApiUO.cs`; funzione `TradeContainer`.
...
Sorgente del progetto: `src/ClassicUO.Client/Game/Managers/ClassicUOInjectionApiBridge.cs`; funzione `TradeContainer`.
...
# Restituisce il serial del proprio contenitore come stringa esadecimale.
#
# String: ID esadecimale come "0x40000011", oppure "0x00000000" se assente. Proprio contenitore,
# non Boolean né stringa vuota.
