...
Annulla lo scambio selezionato e chiude la finestra.
...
Integer: 1 = TRUE se la finestra è stata trovata, chiusa e l’annullamento inviato; altrimenti 0 = FALSE. Non attende il server. Chiudere di nuovo non invia un secondo pacchetto.
...
Sorgente del progetto: `src/ClassicUO.Client/Game/Managers/ClassicUOInjectionApiBridge.cs`; funzione `CancelTrade`.
...
Dispose termina subito se già chiusa, libera l’UI e chiama GameActions.CancelTrade(ID1) una volta.

Integer: 1 = TRUE se la finestra è stata trovata, chiusa e l’annullamento inviato; altrimenti 0 = FALSE. Non attende il server. Chiudere di nuovo non invia un secondo pacchetto.

Sorgente del progetto: `src/ClassicUO.Client/Game/UI/Gumps/TradingGump.cs`; funzione `Dispose`.
...
# Annulla lo scambio selezionato e chiude la finestra.
#
# Integer: 1 = TRUE se la finestra è stata trovata, chiusa e l’annullamento inviato; altrimenti
# 0 = FALSE. Non attende il server. Chiudere di nuovo non invia un secondo pacchetto.
#
