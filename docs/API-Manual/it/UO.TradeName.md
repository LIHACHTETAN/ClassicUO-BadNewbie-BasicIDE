...
Legge il nome del partner con indice della finestra da zero.
...
String: nome conservato del partner; vuota senza finestra/nome. Non usa il nome dell’oggetto contenitore.
...
Sorgente del progetto: `external/InjectionScript/src/InjectionScript/Runtime/InjectionApiUO.cs`; funzione `TradeName`.
...
Sorgente del progetto: `src/ClassicUO.Client/Game/Managers/ClassicUOInjectionApiBridge.cs`; funzione `TradeName`.
...
# Legge il nome del partner con indice della finestra da zero.
#
# String: nome conservato del partner; vuota senza finestra/nome. Non usa il nome dell’oggetto
# contenitore.
