...
Liest die numerische Serial des Handelspartners.
...
Integer: Charakter-Serial aus LocalSerial des Fensters; 0 bei fehlendem Fenster. Kein Behälter oder Boolean; <> 0 testen.
...
Projektquelle: `src/ClassicUO.Client/Game/Managers/ClassicUOInjectionApiBridge.cs`; Funktion `GetTradeOpponent`.
...
# Liest die numerische Serial des Handelspartners.
#
# Integer: Charakter-Serial aus LocalSerial des Fensters; 0 bei fehlendem Fenster. Kein Behälter
# oder Boolean; <> 0 testen.
