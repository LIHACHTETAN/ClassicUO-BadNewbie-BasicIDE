...
Liest den Partnernamen über einen nullbasierten Fensterindex.
...
String: gespeicherter Partnername; leer ohne Fenster/Namen. Der Name des Behälter-Items wird nicht gelesen.
...
Projektquelle: `external/InjectionScript/src/InjectionScript/Runtime/InjectionApiUO.cs`; Funktion `TradeName`.
...
Projektquelle: `src/ClassicUO.Client/Game/Managers/ClassicUOInjectionApiBridge.cs`; Funktion `TradeName`.
...
# Liest den Partnernamen über einen nullbasierten Fensterindex.
#
# String: gespeicherter Partnername; leer ohne Fenster/Namen. Der Name des Behälter-Items wird
# nicht gelesen.
