...
String: 거래 열기 패킷에서 받은 이름이며 창/이름이 없으면 빈 문자열입니다. 새 이름을 요청하지 않습니다.
...
프로젝트 소스: `src/ClassicUO.Client/Game/Managers/ClassicUOInjectionApiBridge.cs`; 함수 `GetTradeOpponentName`.
