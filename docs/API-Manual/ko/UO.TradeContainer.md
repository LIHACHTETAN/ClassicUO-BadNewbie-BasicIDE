...
내 거래 컨테이너 serial을 16진수 문자열로 반환합니다.
...
String: "0x40000011" 같은 16진수 ID이며 없으면 "0x00000000"입니다. 내 컨테이너이며 Boolean이나 빈 문자열이 아닙니다.
...
프로젝트 소스: `external/InjectionScript/src/InjectionScript/Runtime/InjectionApiUO.cs`; 함수 `TradeContainer`.
...
프로젝트 소스: `src/ClassicUO.Client/Game/Managers/ClassicUOInjectionApiBridge.cs`; 함수 `TradeContainer`.
