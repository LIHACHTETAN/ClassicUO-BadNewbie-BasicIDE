...
Integer: 창의 LocalSerial에 저장된 상대 캐릭터 serial이며 창이 없으면 0입니다. 컨테이너나 Boolean이 아니며 <> 0으로 확인합니다.
...
프로젝트 소스: `src/ClassicUO.Client/Game/Managers/ClassicUOInjectionApiBridge.cs`; 함수 `GetTradeOpponent`.
