...
String: 저장된 상대 이름이며 창/이름이 없으면 빈 문자열입니다. 컨테이너 아이템 이름은 읽지 않습니다.
...
프로젝트 소스: `external/InjectionScript/src/InjectionScript/Runtime/InjectionApiUO.cs`; 함수 `TradeName`.
...
프로젝트 소스: `src/ClassicUO.Client/Game/Managers/ClassicUOInjectionApiBridge.cs`; 함수 `TradeName`.
